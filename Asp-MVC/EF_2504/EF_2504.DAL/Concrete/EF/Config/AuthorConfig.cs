...
namespace EF_2504.DAL.Concrete.EF.Config
{
    public class AuthorConfig : IEntityTypeConfiguration<Author>
    {
        public void Configure(EntityTypeBuilder<Author> builder)
        {
            ...
            builder.Ignore(a => a.AuthorFullName); //bunu tablo oluşturulurken alma.
            ...
            builder.HasData(
                ...
                new Author { AuthorId=2, AuthorFirstName="Recep", AuthorLastName="Çelimli"},
                new Author { AuthorId = 3, AuthorFirstName = "Doğukan", AuthorLastName = "Durkaya" }
                );
        }
    }
}
