...
namespace MiniShopApp.WebUI.Models
{
    public class ProductModel
    {
        ...
        [Range(1, 50000, ErrorMessage = "Lütfen 1-50000 arasında değer giriniz!")]
        ...
        public List<Category> SelectedCategories { get; set; }     //ilgili product ın sahip olduğu kategoriler
    }
}
