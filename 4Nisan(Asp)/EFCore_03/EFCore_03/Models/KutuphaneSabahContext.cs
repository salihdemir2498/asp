...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-4JE8ADO\\SQLEXPRESS;Database=KutuphaneSabah;Trusted_Connection=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Kitaplar>(entity =>
            {
                entity.HasKey(e => e.Isbn)
                    .HasName("PK__Kitaplar__447D36EB4E2EBD1E");
            ...
            modelBuilder.Entity<Turler>(entity =>
            {
                ...
                entity.HasIndex(e => e.TurAd, "UQ__Turler__A1D0193DBF397B07")
                    .IsUnique();
            ...
            modelBuilder.Entity<Yayinevleri>(entity =>
            {
                ...
                entity.HasIndex(e => e.Ad, "UQ__Yayinevl__3214AD00F069ADB3")
                    .IsUnique();
